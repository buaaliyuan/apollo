...
find_package(Eigen3 REQUIRED NO_DEFAULT_PATH
    PATHS
        /apollo/thirdparty/install
)
#需要写在eigen3.3.54 
list(APPEND CMAKE_PREFIX_PATH "/apollo/thirdparty/install")
set(EIGEN_INCLUDE_DIRS "/apollo/thirdparty/install/include/eigen3" CACHE PATH "Eigen3 include dir")
...
if(APOLLO_USE_GPU)
    ...
    if(_PADDLE_INC_ROOT)
        ...
        if(EXISTS "${_PADDLE_MKLDNN_SO}")
            ...
            message(STATUS "Paddle include dir: ${_PADDLE_INC_ROOT}")
        else()
